...
public class Game 
{
    ...
    private void createRooms()
    {
        ...
        Item counter = new Item("counter", 10, false);
        SaleItem beer = new SaleItem("beer", 0.2, 4.5);
        Item stool = new Item("stool", 2, true);
        SaleItem chips = new SaleItem("chips", 0.1, 2);
        pub.putInRoom(counter);
        pub.putInRoom(beer);
        pub.putInRoom(stool);
        pub.putInRoom(chips);
    ...
    {
        if (route.empty()) {
            System.out.println("Cannot go back. You are at the starting point!");
        } else {
